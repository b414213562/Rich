-- Barter Items for Festival Event

_TOKENS =
	{
	[1] = 1879206049;	-- Burried Treasure Token
	};

_BARTER =
	{
	-- 1 = ID	2 = Token/Qty	3 = Qty (or nil)\
    [01] = {[1]="DIVIDER1"; [2]={["ENGLISH"] = "Sigtír"}};
	[02] = {[1]=1879205891;[2]={[1]=1;};};		-- Dowsing Gem
	[03] = {[1]=1879205890;[2]={[1]=5;};};		-- Trained Cave-claw Cage
	...
	[10] = {[1]=1879206820;[2]={[1]=100;};};	-- Gold Panning
	[11] = {[1]=1879206821;[2]={[1]=30;};};		-- Dowse
	...
	[23] = {[1]=1879255355;[2]={[1]=1000;};};	-- Harvest-brew Goat
	[24] = {[1]=1879255443;[2]={[1]=500;};};	-- Unearthed Sack
	[25] = {[1]=1879314475;[2]={[1]=500;};}; 	-- Tome of the Treasure-seeking Cave-claw
	[26] = {[1]=1879315057;[2]={[1]=500;};}; 	-- Tome of the Tan-back Cave-claw
	[27] = {[1]=1879315061;[2]={[1]=500;};}; 	-- Tome of the Green-beak Cave-claw
	[28] = {[1]=1879315064;[2]={[1]=500;};}; 	-- Tome of the Pink-beak Cave-claw
	...
	[35] = {[1]=1879305775;[2]={[1]=375;};};	-- Tome of the Scrapper Chicken
	[36] = {[1]=1879305774;[2]={[1]=450;};};	-- Tome of the Black-foot Chicken
	[37] = {[1]=1879305773;[2]={[1]=525;};};	-- Tome of the Orange Wyandotte Chicken
	[38] = {[1]=1879305713;[2]={[1]=60;};};		-- Standing Streamer
	[39] = {[1]=1879305732;[2]={[1]=60;};};		-- Seedy Hobbit Waggon
	[40] = {[1]=1879305714;[2]={[1]=90;};};		-- Yellow Hobbit Waggon
	[41] = {[1]=1879305707;[2]={[1]=90;};};		-- Red Hobbit Waggon
	[42] = {[1]=1879305717;[2]={[1]=90;};};		-- Green Hobbit Waggon
	...
	[49] = {[1]=1879305865;[2]={[1]=10;};};		-- Sticky Apple Recipe
	[50] = {[1]=1879305868;[2]={[1]=10;};};		-- Took in the Hole Recipe
	[51] = {[1]=1879305866;[2]={[1]=2;};};		-- Flagon of 'Shire-Honey' Mead Recipe
	[52] = {[1]=1879305863;[2]={[1]=2;};};		-- Glass of Dark Stout Recipe
	[53] = {[1]=1879305867;[2]={[1]=2;};};		-- Bottle of 'Sticky Apple' Cider Recipe
	[54] = {[1]=1879305936;[2]={[1]=5;};};		-- Oliphaunt Ear Banquet Recipe
	[55] = {[1]=1879305934;[2]={[1]=5;};};		-- Roasted Coney on a Stick Banquet Recipe
	[56] = {[1]=1879305932;[2]={[1]=5;};};		-- Chicken Wing Banquet Recipe
	[57] = {[1]=1879305935;[2]={[1]=5;};};		-- Sticky Apple Banquet Recipe
	...
	[64] = {[1]=1879305620;[2]={[1]=5;};};		-- Facepaint Stencil - Feather
	[65] = {[1]=1879305618;[2]={[1]=5;};};		-- Facepaint Stencil - Star
	[66] = {[1]=1879305615;[2]={[1]=5;};};		-- Facepaint Stencil - Sword
	[67] = {[1]=1879305621;[2]={[1]=5;};};		-- Facepaint Stencil - Bow
	[68] = {[1]=1879305617;[2]={[1]=5;};};		-- Facepaint Stencil - Pipe
	[69] = {[1]=1879305705;[2]={[1]=5;};};		-- White Carrying Chicken
	[70] = {[1]=1879305701;[2]={[1]=6;};};		-- Red Carrying Chicken
	[71] = {[1]=1879305706;[2]={[1]=7;};};		-- Dorking Carrying Chicken
	[72] = {[1]=1879305704;[2]={[1]=8;};};		-- Scrapper Carrying Chicken
	[73] = {[1]=1879305703;[2]={[1]=9;};};		-- Black-foot Carrying Chicken
	[74] = {[1]=1879305702;[2]={[1]=10;};};		-- Orange Wyandotte Carrying Chicken
	};
